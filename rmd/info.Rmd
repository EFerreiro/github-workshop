...
knitr::include_graphics(here::here("img", "img_for_slides", "git_install_02.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(here::here("img", "img_for_slides", "git_install_01.png"))
```

1. Use default and/or recommended options
```{r, echo=FALSE}
knitr::include_graphics(here::here("img", "img_for_slides", "git_install_03.png"))
knitr::include_graphics(here::here("img", "img_for_slides", "git_install_04.png"))
```
...
knitr::include_graphics(here::here("img", "img_for_slides", "git_bash.png"))
```
