...
knitr::include_graphics(here::here("img", "final_final.png"))
```
...
1. Go to [https://github.com/](https://github.com/){target="blank"}  
    ...
    knitr::include_graphics(here::here("img", "github_sign_up.png"))
    ```
...
1. Fill the data. Then, verify your account and click on "join a free plan". 
    ...
    knitr::include_graphics(here::here("img", "github_sign_up2.png"))
    ```
...
knitr::include_graphics(here::here("img", "git_install_02.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(here::here("img", "git_install_01.png"))
```

1. Use default and/or recommended options
```{r, echo=FALSE}
knitr::include_graphics(here::here("img", "git_install_03.png"))
knitr::include_graphics(here::here("img", "git_install_04.png"))
```
...
knitr::include_graphics(here::here("img", "git_bash.png"))
```
...
1) Go to **Global Options** of RStudio (Tools -> Global options):  
    ...
    knitr::include_graphics(here::here("img", "RStudio_git2.png"))
    ```
...
a) restart RStudio. Git pane should appeared in your RStudio (if you have the default RStudio settings it should be in upper-right corner):  
    ...
    knitr::include_graphics(here::here("img", "RStudio_git3.png"))
    ```
...
1. Go to to File -> Options:
    ...
    knitr::include_graphics(here::here("img", "Github_desktop1.png"))
    ```

1. Sign in to your account:

    ```{r github options 2, echo=FALSE, out.width = '40%'}
    knitr::include_graphics(here::here("img", "Github_desktop2.png"))
    ```
