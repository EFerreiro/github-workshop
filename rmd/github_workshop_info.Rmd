...
1. Go to to File -> Options:
    ...
    knitr::include_graphics("https://github.com/stmarcin/github-workshop/raw/master/img/Github_desktop1.png")
    ```

1. Sign in to your account:

    ```{r github options 2, echo=FALSE, out.width = '40%'}
    knitr::include_graphics("https://github.com/stmarcin/github-workshop/raw/master/img/Github_desktop2.png")
    ```
